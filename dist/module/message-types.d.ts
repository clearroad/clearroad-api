...
export declare type portalType = 'Billing Period Message' | 'Odometer Reading Message' | 'Road Account Message' | 'Road Event Message' | 'Road Message' | 'Road Report Request' | 'Road Mileage Message';
